...
treefile <- "All_Pmac_Unique_hap_seqs_strict_100M_rename.newick"
geodata <- "Pmac_geog_data.txt"

#set path to working directory (input and output files)
workdir <- "/Applications/R stuff/BioGeoBEARS/BGB_Data_Results_dir"

# set description, for naming output files
description <- "Pmac_test_080716"
